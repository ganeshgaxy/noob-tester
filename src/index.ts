...
import { registerPageConfigCommands } from "./cli/commands/page-config.js";
...
import { registerPoolSpawnsCommands } from "./cli/commands/pool-spawns.js";
import { registerTicketWorkflowCommands } from "./cli/commands/ticket-workflow.js";
...
registerPageConfigCommands(program);
registerAuthCommands(program);
registerSyncCommands(program);
registerQaPoolCommands(program);
registerPoolSpawnsCommands(program);
registerTicketWorkflowCommands(program);
